...
* **02_evol-merger**. We read the file “evol_mergers.out” and classify systems between systems those that go through Common Envelope and those that do not.
...
* **02_evol-merger**. This folder contains the plots obtained by running the code in folder 02_evol-merger.
